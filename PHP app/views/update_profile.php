    ...
    return true;
		...
		<div id="personaldetails">	
			...
			<p class="subtitle">Personal details</p>
                        <form action="<?php echo base_url(); ?>index.php/Update_profile/updateProfile" method="post" enctype="multipart/form-data" name="registration_form" onsubmit="return validateForm()">
                             <?php
                                        ...
                                        $query = "select * from users where id=".$_SESSION['id_user'];
				...
				?>
				<div id="photo">
                                    <input type="file" id="input" name="myfile" value="<?php echo $row['photo'] ?>"/>
				...
				<div id="details">
					...
					<p class="label">First name 	 <input id="firstname" type="text" name="firstname" value="<?php echo $row['first_name'] ?>"></input></p>
                                     
					<p class="label">Surname  <input id="surname" type="text" name="surname" value="<?php echo $row['surname'] ?>"></input></p>
					<p class="label">Telephone  <input id="telephone" type="text" name="telephone" value="<?php echo $row['telephone'] ?>"></input></p>
					<p class="label">Post code  <input id="postcode" type="text" name="postcode" value="<?php echo $row['postcode'] ?>"></input></p>
					<p class="label">Address  <input id="address" type="text" name="address" value="<?php echo $row['address'] ?>"></input></p>
					<input id="address2" type="text" name="address2"></input> <br><br>
					<input id="address2" type="text" name="address3"></input>
					<p class="label">City  <input id="city" type="text" name="city" value="<?php echo $row['city'] ?>"></input></p>
					<p class="label">Email  <input id="email" type="email" name="email" value="<?php echo $row['email'] ?>"></input></p>
                                        <p class="label">Username  <input id="username" type="text" name="username" value="<?php echo $row['username'] ?>" readonly></input></p>
		...
		<div id="skills">
			...
			<input id="savedetails" class="sbtn" type="submit" name="submitBtn" value="Update" ></input>
			</form>
		</div>
	</div>
